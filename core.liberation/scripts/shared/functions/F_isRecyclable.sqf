...
// Checks if player is less than or exactly 5m above the ground OR an aircraft carrier is less than 250m around the player
private _noflight = getPosATL player select 2 <= 5 || count nearestObjects [player, ["Land_Carrier_01_base_F"], 250] > 0;
