...
if ( _wounded ) then {
		...
		_unit setSkill ["aimingaccuracy", [ 0.4 * _skillmodifier ] call limit_skill];
		_unit setSkill ["aimingspeed", [ 0.9 * _skillmodifier ] call limit_skill];
		_unit setSkill ["aimingshake", [ 0.9 * _skillmodifier ] call limit_skill];
