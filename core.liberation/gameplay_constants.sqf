...
msu_opfor_helmet = 'VSM_ProjectHonor_OPS_2';
msu_opfor_uniform = 'VSM_ProjectHonor_Crye_SS_Camo'; // Alpine_white_Crye_camo
msu_opfor_vest = 'VSM_LBT6094_operator_ProjectHonor';
